...
namespace OpenSim.Services.AuthenticationService
{
    public class PemKeyUtils
	{
		...
		public static string GetPublicKey(RSACryptoServiceProvider csp)
		{
			...
			using (var stream = new MemoryStream())
			{
				...
				string test = Convert.ToBase64String(stream.GetBuffer(), 0, (int)stream.Length);

				const String pempubheader = "-----BEGIN PUBLIC KEY-----";
				const String pempubfooter = "-----END PUBLIC KEY-----";
				return pempubheader + Environment.NewLine + test + Environment.NewLine + pempubfooter;
			}
		}
